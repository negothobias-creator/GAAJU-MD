...
const { isAntimentionEnabled } = require('../plugins/antimention');
...
async function handleMessages(sock, messageUpdate) {
    try {
        ...
        if (isGroup) {
            ...
            // Handle antimention detection (delete messages with @group mention or status mentioning group)
            const antibadwordEnabled = await isAntimentionEnabled(chatId);
