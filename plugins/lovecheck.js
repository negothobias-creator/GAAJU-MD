...
module.exports = {
  ...
  aliases: ['love'],
  category: 'fun',
  description: 'Check how much someone is in love (random percent)',
  usage: '.lovecheck (reply/mention someone)',
  ...
  async handler(sock, message, args, context = {}) {
    ...
    const text = `💘 *Love Checker*\n@${target.split('@')[0]} is *${percent}%* in love!`;
